// TTO Strategy Engine - 完全動作版
const PRODUCT = "KINUI"; // デフォルト商品名
...
const BuzzKnowledge = {
    score: {
        ...
        slides: [
            ...
            { num: 2, role: '洗顔', title: "洗顔の温度", options: [{ pt: "0点", name: "32度", desc: "美肌の黄金温度" }, { pt: "1点", name: "冷水", desc: "汚れ固まる" }, { pt: "2点", name: "熱いシャワー", desc: "肌への暴力" }], reason: "常識破壊。シャワーを2点にする。", img: "洗顔シーン" },
            ...
            { num: 4, role: '趣味', title: "趣味", options: [{ pt: "0点", name: "筋トレ", desc: "若返りホルモン" }, { pt: "1点", name: "サウナ", desc: "皮脂過剰注意" }, { pt: "2点", name: "喫煙", desc: "土色肌＋悪臭" }], reason: "人気のサウナを1点にして滞在時間を稼ぐ。", img: "趣味素材" },
            ...
            { num: 7, role: '要約', title: "垢抜けの鉄則", reason: "落とすケアが9割であると結論づける。", img: "美肌男性画像" },
            { num: 8, role: '行動', title: "合計何点だった？👇", reason: "点数を書かせる。", img: "美女の微笑み" }
        ]
    },
    binary: {
        name: "二項対立 (神vsゴミ)",
        ...
        slides: [
            ...
            { num: 3, role: 'タオル', title: "タオルの使用", options: [{ type: "ゴミ", name: "共用タオル", desc: "雑菌の温床" }, { type: "神", name: "洗顔紙", desc: "常に清潔" }], reason: "衛生観念で危機感を煽る。", img: "タオル対比" },
            ...
            { num: 6, role: '具体的理由', title: "なぜこれが神か？", reason: "プロの視点でロジカルに解説。", img: "成分イメージ" },
